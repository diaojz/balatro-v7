// v7.16：对齐 Balatro 官方术语 — 三种盲注名「小盲注 / 大盲注 / Boss盲注」（不是 小/中/大）
// 一个底注（Ante）= 3 个盲注；v7 自定义第 4 底注只 1 关「终极 Boss」
export const BLINDS = [
  // ===== 底注 1 =====
  { id: 'a1-small', name: '小盲注',     target: 300,   icon: '🔵', ante: 1 },
  { id: 'a1-big',   name: '大盲注',     target: 500,   icon: '🟡', ante: 1 },
  { id: 'a1-boss',  name: 'Boss 盲注', target: 800,   icon: '🔴', ante: 1 },
  // ===== 底注 2 =====
  { id: 'a2-small', name: '小盲注',     target: 1200,  icon: '🔵', ante: 2 },
  { id: 'a2-big',   name: '大盲注',     target: 1800,  icon: '🟡', ante: 2 },
  { id: 'a2-boss',  name: 'Boss 盲注', target: 3000,  icon: '🔴', ante: 2 },
  // ===== 底注 3 =====
  { id: 'a3-small', name: '小盲注',     target: 4500,  icon: '🔵', ante: 3 },
  { id: 'a3-big',   name: '大盲注',     target: 7000,  icon: '🟡', ante: 3 },
  { id: 'a3-boss',  name: 'Boss 盲注', target: 11000, icon: '🔴', ante: 3 },
  // ===== 底注 4 终极（v7 自定义单关） =====
